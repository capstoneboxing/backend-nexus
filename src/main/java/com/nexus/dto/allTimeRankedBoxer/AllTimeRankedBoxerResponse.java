...
@Schema(description = "Response containing a ranked all-time boxer profile used in a generation batch")
public record AllTimeRankedBoxerResponse(
        @Schema(description = "Unique ID of the ranked boxer record", example = "1")
        Integer rankedBoxerId,

        @Schema(description = "Batch ID this ranked boxer belongs to", example = "1")
        Integer batchId,
        ...
        @Schema(description = "Ranking position of the boxer within the batch", example = "1")
        ...
        @Schema(description = "Date and time when this ranked boxer record was generated", example = "2026-03-27T18:30:00Z")
